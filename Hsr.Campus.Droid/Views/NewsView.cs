...
namespace Hsr.Campus.Droid.Views
{
    ...
    [Activity(Label = "@string/TileNews", Theme = "@style/Theme.View", Icon = "@drawable/ic_launcher")]
    public class NewsView : TabViewPagerActivity<NewsViewModel, BaseItemView>
    {
...
#pragma warning restore 4014
        ...
        protected override void OnCreate(Bundle bundle)
        {
            ...
            this.SetContentView(Resource.Layout.NewsView);
