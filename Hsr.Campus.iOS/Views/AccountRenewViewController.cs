...
namespace Hsr.Campus.iOS
{
    ...
    internal partial class AccountRenewViewController : MvxViewController<AccountViewModel>
    {
        public AccountRenewViewController(IntPtr handle)
            : base(handle)
        {
        }
        ...
        public override void ViewDidLoad()
        {
            ...
            this.ContentText.Text = AppResources.OAuthRenew;
